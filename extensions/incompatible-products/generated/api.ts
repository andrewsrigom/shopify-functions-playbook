...
/** The output of the Function run target. The object contains the validation errors that display to customers and prevent them from proceeding through checkout. */
...
/** The output of the Function run target. The object contains the validation errors that display to customers and prevent them from proceeding through checkout. In API versions 2023-10 and beyond, this type is deprecated in favor of `FunctionRunResult`. */
...
export type Input = {
   ...
   */
  cart: Cart;
  /** The `FunctionFetchResult` object is the result of the fetch target. This is the response that Shopify returns after executing the HTTP request defined in your fetch target, and that is passed as input to the run target. For more information, refer to [network access for Shopify Functions](https://shopify.dev/docs/apps/build/functions/input-output/network-access). */
...
export type Operation = {
   ...
   */
  validationAdd?: InputMaybe<ValidationAddOperation>;
};
