...
export type CartDeliveryOptionsDiscountsGenerateRunInput = { cart: { lines: Array<{ id: string }>, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode } }, deliveryGroups: Array<{ deliveryOptions: Array<{ handle: string, title: string | null }> }> }, discount: { discountClasses: Array<DiscountClass>, config: { jsonValue: unknown } | null } };
