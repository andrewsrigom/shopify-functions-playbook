...
/** The cart.delivery-options.discounts.generate.fetch target result. Refer to [network access](https://shopify.dev/apps/build/functions/input-output/network-access/graphql) for Shopify Functions. */
...
/** The cart.lines.discounts.generate.fetch target result. Refer to [network access](https://shopify.dev/apps/build/functions/input-output/network-access/graphql) for Shopify Functions. */
...
export type CartOperation = {
  ...
  enteredDiscountCodesAccept?: InputMaybe<EnteredDiscountCodesAcceptOperation>;
  ...
  enteredDiscountCodesReject?: InputMaybe<EnteredDiscountCodesRejectOperation>;
  /** An operation that applies order discounts to a cart that share a selection strategy. */
  orderDiscountsAdd?: InputMaybe<OrderDiscountsAddOperation>;
  /** An operation that applies product discounts to a cart that share a selection strategy. */
  productDiscountsAdd?: InputMaybe<ProductDiscountsAddOperation>;
};
...
export type Condition = {
  /** The condition for checking the minimum quantity of products across a group of cart lines. */
  cartLineMinimumQuantity?: InputMaybe<CartLineMinimumQuantity>;
  /** The condition for checking the minimum subtotal of products across a group of cart lines. */
  cartLineMinimumSubtotal?: InputMaybe<CartLineMinimumSubtotal>;
  /** The condition for checking the minimum subtotal amount of the order. */
  orderMinimumSubtotal?: InputMaybe<OrderMinimumSubtotal>;
};
...
export type DeliveryDiscountCandidateTarget = {
   ...
   */
  deliveryGroup?: InputMaybe<DeliveryGroupTarget>;
  /**
   ...
   */
  deliveryOption?: InputMaybe<DeliveryOptionTarget>;
};

/** The value of the eligible delivery discount. */
export type DeliveryDiscountCandidateValue = {
  /** A fixed amount value. */
  fixedAmount?: InputMaybe<FixedAmount>;
  /** A percentage value. */
  percentage?: InputMaybe<Percentage>;
};
...
export enum DeliveryDiscountSelectionStrategy {
  /**
   * Apply all discounts that are eligible to be applied to a delivery with conditions that are satisfied. This doesn't override
...
/** The operations to apply discounts to shipping and delivery charges in a customer's cart. These operations allow you to reduce the cost of shipping by applying percentage or fixed-amount discounts to specific delivery options (such as standard shipping and express shipping) or delivery groups (such as collections of delivery options). */
export type DeliveryOperation = {
  /** Applies delivery discounts to a cart that share a method for determining which shipping and delivery discounts to apply when multiple discounts are eligible. */
  deliveryDiscountsAdd?: InputMaybe<DeliveryDiscountsAddOperation>;
  /** An operation that selects which entered discount codes to accept. Use this to validate discount codes from external systems. */
  enteredDiscountCodesAccept?: InputMaybe<EnteredDiscountCodesAcceptOperation>;
  /** An operation that rejects entered discount codes with a custom message. Use this to conditionally reject discount codes based on business logic. This operation can only be used if the function is backed by an automatic discount. */
  enteredDiscountCodesReject?: InputMaybe<EnteredDiscountCodesRejectOperation>;
...
export type OrderDiscountCandidateTarget = {
   ...
   */
  orderSubtotal?: InputMaybe<OrderSubtotalTarget>;
};
...
export type ProductDiscountCandidatePrerequisite = {
   ...
   * different sizes of the same t-shirt to their cart, then each size is represented as a separate cart line.
   */
  cartLine?: InputMaybe<CartLinePrerequisite>;
};

/**
 * Defines discount candidates, which are cart lines that may be eligible for potential discounts. Use discount candidates to identify items in a customer's cart that could receive discounts based on conditions in the selection strategy.
 *
 * When multiple cart lines share the same type and ID, the system treats them as a single target and combines their quantities. The combined quantity becomes null if any individual target has a `null` quantity.
 */
