...
export type CartLinesDiscountsGenerateRunInput = { cart: { lines: Array<{ id: string, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode } }, merchandise:
        | { __typename: 'CustomProduct' }
        | { __typename: 'ProductVariant', id: string }
       }> }, discount: { discountClasses: Array<DiscountClass>, config: { jsonValue: unknown } | null } };
